...
pub type og_thread_t = *mut ::std::os::raw::c_void;
pub type og_mutex_t = *mut ::std::os::raw::c_void;
pub type og_sema_t = *mut ::std::os::raw::c_void;
pub type og_tls_t = *mut ::std::os::raw::c_void;
...
pub struct NoteDists {
    ...
    pub mean: f32,
    pub sigma: f32,
    pub taken: ::std::os::raw::c_uchar,
}
#[test]
fn bindgen_test_layout_NoteDists() {
    assert_eq!(
        ::std::mem::size_of::<NoteDists>(),
        16usize,
        concat!("Size of: ", stringify!(NoteDists))
    );
    assert_eq!(
        ::std::mem::align_of::<NoteDists>(),
        4usize,
        concat!("Alignment of ", stringify!(NoteDists))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteDists>())).amp as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteDists),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteDists>())).mean as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteDists),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteDists>())).sigma as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteDists),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteDists>())).taken as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteDists),
...
pub struct NoteFinder {
    pub ofreqs: ::std::os::raw::c_int,
    pub slope: f32,
    pub octaves: ::std::os::raw::c_int,
    pub freqbins: ::std::os::raw::c_int,
    pub note_peaks: ::std::os::raw::c_int,
    pub base_hz: f32,
    pub filter_strength: f32,
    pub filter_iter: ::std::os::raw::c_int,
    pub decompose_iterations: ::std::os::raw::c_int,
    pub amplify: f32,
    pub compress_coefficient: f32,
    pub compress_exponenet: f32,
    pub do_progressive_dft: ::std::os::raw::c_int,
    pub dft_speedup: f32,
    pub dft_q: f32,
    pub dft_iir: f32,
    pub default_sigma: f32,
    pub note_jumpability: f32,
    pub note_combine_distance: f32,
    pub note_attach_freq_iir: f32,
    pub note_attach_amp_iir: f32,
    pub note_attach_amp_iir2: f32,
    pub note_min_amplitude: f32,
    pub note_minimum_new_distribution_value: f32,
    pub note_out_chop: f32,
    pub sps_rec: f32,
    pub note_positions: *mut f32,
    pub note_amplitudes_out: *mut f32,
    pub note_amplitudes2: *mut f32,
    pub note_amplitudes: *mut f32,
    pub note_founds: *mut ::std::os::raw::c_uchar,
    pub note_peaks_to_dists_mapping: *mut ::std::os::raw::c_char,
    pub enduring_note_id: *mut ::std::os::raw::c_int,
    pub current_note_id: ::std::os::raw::c_int,
    pub frequencies: *mut f32,
    pub outbins: *mut f32,
    pub folded_bins: *mut f32,
    pub dists_count: ::std::os::raw::c_int,
    pub dists: *mut NoteDists,
    pub StartTime: f64,
    pub DFTTime: f64,
    pub FilterTime: f64,
    pub DecomposeTime: f64,
    pub FinalizeTime: f64,
}
#[test]
fn bindgen_test_layout_NoteFinder() {
    assert_eq!(
        ::std::mem::size_of::<NoteFinder>(),
        248usize,
        concat!("Size of: ", stringify!(NoteFinder))
    );
    assert_eq!(
        ::std::mem::align_of::<NoteFinder>(),
        8usize,
        concat!("Alignment of ", stringify!(NoteFinder))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).ofreqs as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(ofreqs)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).slope as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).octaves as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).freqbins as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_peaks as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_peaks)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).base_hz as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).filter_strength as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).filter_iter as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(filter_iter)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).decompose_iterations as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(decompose_iterations)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).amplify as *const _ as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).compress_coefficient as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(compress_coefficient)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).compress_exponenet as *const _ as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(compress_exponenet)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).do_progressive_dft as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(do_progressive_dft)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).dft_speedup as *const _ as usize },
        52usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(dft_speedup)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).dft_q as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).dft_iir as *const _ as usize },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).default_sigma as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(default_sigma)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_jumpability as *const _ as usize },
        68usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_jumpability)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NoteFinder>())).note_combine_distance as *const _ as usize
        },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_combine_distance)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_attach_freq_iir as *const _ as usize },
        76usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_attach_freq_iir)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_attach_amp_iir as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_attach_amp_iir)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_attach_amp_iir2 as *const _ as usize },
        84usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_attach_amp_iir2)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_min_amplitude as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_min_amplitude)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NoteFinder>())).note_minimum_new_distribution_value as *const _
                as usize
        },
        92usize,
        concat!(
            ...
            stringify!(NoteFinder),
            "::",
            stringify!(note_minimum_new_distribution_value)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_out_chop as *const _ as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_out_chop)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).sps_rec as *const _ as usize },
        100usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_positions as *const _ as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_positions)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_amplitudes_out as *const _ as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_amplitudes_out)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_amplitudes2 as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_amplitudes2)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_amplitudes as *const _ as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_amplitudes)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).note_founds as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_founds)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NoteFinder>())).note_peaks_to_dists_mapping as *const _ as usize
        },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(note_peaks_to_dists_mapping)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).enduring_note_id as *const _ as usize },
        152usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(enduring_note_id)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).current_note_id as *const _ as usize },
        160usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(current_note_id)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).frequencies as *const _ as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).outbins as *const _ as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).folded_bins as *const _ as usize },
        184usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(folded_bins)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).dists_count as *const _ as usize },
        192usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(dists_count)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).dists as *const _ as usize },
        200usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).StartTime as *const _ as usize },
        208usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).DFTTime as *const _ as usize },
        216usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).FilterTime as *const _ as usize },
        224usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(FilterTime)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).DecomposeTime as *const _ as usize },
        232usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(DecomposeTime)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NoteFinder>())).FinalizeTime as *const _ as usize },
        240usize,
        concat!(
            "Offset of field: ",
            stringify!(NoteFinder),
            "::",
            stringify!(FinalizeTime)
        )
    );
}
extern "C" {
    pub fn CreateNoteFinder(spsRec: ::std::os::raw::c_int) -> *mut NoteFinder;
}
extern "C" {
    pub fn ChangeNFParameters(v: *mut ::std::os::raw::c_void);
}
extern "C" {
    pub fn RunNoteFinder(
        nf: *mut NoteFinder,
        audio_stream: *const f32,
        head: ::std::os::raw::c_int,
        buffersize: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn DecomposeHistogram(
        histogram: *mut f32,
        bins: ::std::os::raw::c_int,
        out_dists: *mut NoteDists,
        max_dists: ::std::os::raw::c_int,
        default_sigma: f64,
