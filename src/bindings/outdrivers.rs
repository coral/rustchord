...
pub const MAX_LEDS: u32 = 32678;
pub const MAX_OUT_DRIVERS: u32 = 64;
pub const MAX_OUT_DRIVER_STRING: u32 = 1024;
...
extern "C" {
    pub static mut force_white: ::std::os::raw::c_int;
}
extern "C" {
    pub static mut OutLEDs: [::std::os::raw::c_uchar; 98034usize];
}
extern "C" {
    pub static mut UsedLEDs: ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct OutDriverListElem {
    pub Name: *const ::std::os::raw::c_char,
    pub Init: ::std::option::Option<unsafe extern "C" fn() -> *mut DriverInstances>,
}
#[test]
fn bindgen_test_layout_OutDriverListElem() {
    assert_eq!(
        ::std::mem::size_of::<OutDriverListElem>(),
        16usize,
        concat!("Size of: ", stringify!(OutDriverListElem))
    );
    assert_eq!(
        ::std::mem::align_of::<OutDriverListElem>(),
        8usize,
        concat!("Alignment of ", stringify!(OutDriverListElem))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OutDriverListElem>())).Name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OutDriverListElem),
            "::",
            stringify!(Name)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OutDriverListElem>())).Init as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(OutDriverListElem),
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct DriverInstances {
    pub id: *mut ::std::os::raw::c_void,
    pub Func: ::std::option::Option<
        unsafe extern "C" fn(id: *mut ::std::os::raw::c_void, nf: *mut NoteFinder),
    >,
    pub Params: ::std::option::Option<unsafe extern "C" fn(id: *mut ::std::os::raw::c_void)>,
}
#[test]
fn bindgen_test_layout_DriverInstances() {
    assert_eq!(
        ::std::mem::size_of::<DriverInstances>(),
        24usize,
        concat!("Size of: ", stringify!(DriverInstances))
    );
    assert_eq!(
        ::std::mem::align_of::<DriverInstances>(),
        8usize,
        concat!("Alignment of ", stringify!(DriverInstances))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DriverInstances>())).id as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(DriverInstances),
            "::",
            stringify!(id)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DriverInstances>())).Func as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(DriverInstances),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DriverInstances>())).Params as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(DriverInstances),
...
extern "C" {
    pub static mut ODList: [OutDriverListElem; 64usize];
}
extern "C" {
    pub static OutDriverParameters: [::std::os::raw::c_char; 1024usize];
}
extern "C" {
    pub fn SetupOutDriver(drivername: *const ::std::os::raw::c_char) -> *mut DriverInstances;
}
extern "C" {
    pub fn RegOutDriver(
        ron: *const ::std::os::raw::c_char,
        Init: ::std::option::Option<unsafe extern "C" fn() -> *mut DriverInstances>,
    );
}
